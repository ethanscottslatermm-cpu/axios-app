  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center overflow-hidden relative">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/assets/axios-hero.jpg')",
      ...
      <div className="relative z-20 flex flex-col items-center w-full max-w-md px-6">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-white/40 text-[10px] tracking-[0.42em] uppercase mt-1">I Am Worthy</p>
        </div>

        {/* Tagline */}
        <div className="text-center mb-8">
          <p className="text-white/28 text-[10px] tracking-[0.25em] uppercase mb-2">Est. 1989</p>
          <p className="text-white/60 text-[15px] font-light leading-relaxed">
            Discipline. Accountability. Personal ownership.
          </p>
        </div>
        ...
        <form
          ...
          className="w-full bg-white/[0.06] border border-white/[0.15] rounded-sm p-8 backdrop-blur-sm"
        >
          <p className="text-white/30 text-[10px] tracking-[0.3em] uppercase mb-6 text-center">Secure Access</p>
          ...
          {error && (
            <p className="text-red-400/80 text-xs mb-4 tracking-wide text-center">{error}</p>
          )}
        ...
        <p className="text-white/20 text-[9px] tracking-[0.15em] uppercase mt-6">
          "Axios" — I am worthy
        </p>
      </div>
