...
export const THEMES = {
  axios: {
    name: 'Axios Platinum',
    description: 'Black with platinum — the signature look',
    preview: ['#080808', '#0e0e0e', '#E2E2E4'],
    vars: {
      '--bg-primary':    '#080808',
      '--bg-secondary':  '#0e0e0e',
      '--bg-card':       'rgba(226,226,228,0.05)',
      '--bg-card-hover': 'rgba(226,226,228,0.09)',
      '--border':        'rgba(226,226,228,0.25)',
      '--border-focus':  'rgba(226,226,228,0.65)',
      '--text-primary':  '#ffffff',
      '--text-secondary':'rgba(255,255,255,0.65)',
      '--text-muted':    'rgba(255,255,255,0.38)',
      '--text-faint':    'rgba(255,255,255,0.18)',
      '--glow':          'rgba(226,226,228,0.60)',
      '--glow-bar':      '#E2E2E4',
      '--btn-bg':        '#E2E2E4',
      '--btn-text':      '#080808',
      ...
      '--sheet-bg':      '#0d0d0d',
      '--input-bg':      'rgba(226,226,228,0.05)',
      '--img-opacity':   '0.11',
      '--scrollbar':     'rgba(226,226,228,0.20)',
      '--badge-bg':      'rgba(226,226,228,0.09)',
      '--stat-bg':       'rgba(226,226,228,0.06)',
      '--card-shadow':   '0 0 0 0.5px rgba(226,226,228,0.15), 0 0 18px rgba(226,226,228,0.07), 0 2px 10px rgba(0,0,0,0.5)',
    }
  },
  obsidian: {
    name: 'Obsidian',
